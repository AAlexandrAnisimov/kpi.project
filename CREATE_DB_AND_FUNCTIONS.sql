...
CREATE TABLE IF NOT EXISTS reviews(
    ...
    fk_course_id INT,
    review_score INT,
    review_pros varchar(256),
	review_cons varchar(256),
    review_comment TEXT,
    review_day_posted date DEFAULT CURRENT_DATE,
	PRIMARY KEY(review_id),
	CONSTRAINT fk_s_id FOREIGN KEY (fk_student_id) REFERENCES students(student_id),
	CONSTRAINT fk_c_id FOREIGN KEY (fk_course_id) REFERENCES courses(course_id)
);
